...
import { Check, Copy, FileJson, Minimize2, Trash2 } from "lucide-react"
    ...
    <div className="grid gap-6">
      <Card className="border-primary/20 transition-all duration-300 hover:border-primary/30">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            >
              <FileJson className={`w-4 h-4 ${isProcessing ? "animate-spin" : ""}`} />
      ...
      {(output || error) && (
        <Card className="border-primary/20 animate-in transition-all duration-300 hover:border-primary/30">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="font-mono text-lg">{error ? "$ error" : "$ output.json"}</CardTitle>
